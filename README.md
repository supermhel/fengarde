...
| **Dashboard: screenshot/video product tour** | ✅ Works (2026-08-20) | `docs/index.html` + `docs/tour.mp4` — 8 real screenshots and a 16s Ken-Burns video captured off the live stack, published to GitHub Pages (`main:/docs`, already configured — an `index.html` never existed there before) and mirrored as a self-contained Claude artifact. Goes live at `https://supermhel.github.io/fengarde/` once this lands on `main`, not before |
