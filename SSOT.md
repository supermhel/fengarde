...
| `docs/superpowers/specs/2026-07-15-argiem-combined-plan.md` | Combined forward roadmap: status re-baseline + merged PLAN_A/PLAN_C milestones M1-M7 (launch gated on MSP readiness) | **Current forward roadmap** — supersedes the v0.4 build plan for planning purposes |
